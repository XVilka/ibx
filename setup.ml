...
(* OASIS_START *)
(* DO NOT EDIT (digest: ad3d3e297d385933e5401b4274b4c711) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("core",
                               Some (OASISVersion.VGreaterEqual "111.06.00"));
                           FindlibPackage
                             ("async",
                               Some (OASISVersion.VGreaterEqual "111.03.00"));
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\025\227\0268\004\012\rF\235\191@M\201\187c\224";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
