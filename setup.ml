...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1a3b6fb60ac16317f94b431a5bf0c040) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("core",
                               Some (OASISVersion.VGreaterEqual "112.17.00"));
                           FindlibPackage
                             ("async",
                               Some (OASISVersion.VGreaterEqual "112.17.00"));
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\175\019N\210I\0116\2259\148G\177A\177\164\186";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
