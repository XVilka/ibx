...
(* OASIS_START *)
(* DO NOT EDIT (digest: b0fa61a20cbdada8e7952559d7aa8098) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("core",
                               Some (OASISVersion.VGreaterEqual "113.33.03"));
                           FindlibPackage
                             ("async",
                               Some (OASISVersion.VGreaterEqual "113.33.03"));
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "@b\001\t\017\132\218\015F\127\2194\211\143Y~";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
