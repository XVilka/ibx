...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7281e98c69be09bab397e7b20b68af3a) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("core",
                               Some (OASISVersion.VGreaterEqual "113.33.00"));
                           FindlibPackage
                             ("async",
                               Some (OASISVersion.VGreaterEqual "113.33.00"));
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "futures_chain.ml"});
               Executable
                 ({
                     cs_name = "last_price";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "plot_history.ml"});
               Executable
                 ({
                     cs_name = "plot_taq_data";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "print_realtime_bars.ml"
                   });
               Executable
                 ({
                     cs_name = "option_chain";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "option_chain.ml"});
               Executable
                 ({
                     cs_name = "quote_table";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "show_portfolio.ml"});
               Executable
                 ({
                     cs_name = "submit_orders";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\190K\244\026\237\146\015\216\225\187\182dQR\147b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
